...
- **PY-AGENT-PROJECT-010**: Requires ASP Python dev dependencies to mount an actual pytest gate.
...
- **PY-TEST-R002**: Keeps tests root limited to ASP Python configuration and owned suite directories.
