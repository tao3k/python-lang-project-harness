...
def test_modern_design_rule_pack_reports_numbered_rules_in_compact_snapshot(
    ...
    output = render_asp_python_report(
        run_asp_python_paths([source], rule_packs=(PythonModernDesignRulePack(),))
    )
...
def test_modern_design_rule_pack_requires_all_for_package_facade(
    ...
    report = run_asp_python_paths([package], rule_packs=(PythonModernDesignRulePack(),))
